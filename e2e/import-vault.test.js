...
const fixtureVult = path.resolve(
  __dirname,
  'fixtures',
  'test-vault.vult'
)
const fixtureBak = path.resolve(
  __dirname,
  'fixtures',
  'test-vault.bak'
)
...
describe('Import Vault', () => {
  ...
  describe('Navigation to ImportVault', () => {
    ...
    it('should show supported file types hint', async () => {
      await expect(
        element(by.text('Supported file types: .bak & .vult'))
      ).toBeVisible()
    })
  ...
  describe('Import .vult with correct password', () => {
    ...
    it('should decrypt and import with correct password', async () => {
      await element(by.id('decrypt-password-input')).typeText(
        FIXTURE_PASSWORD
      )
  ...
  describe('Persistence — imported vault survives relaunch', () => {
    ...
    it('should not show migration flow on relaunch', async () => {
      ...
      if (migrationShown) {
        throw new Error(
          'Migration flow should not appear after successful import'
        )
      }
    })
  ...
  describe('Wrong password shows error', () => {
    ...
    it('should keep password sheet open after error', async () => {
      await expect(
        element(by.id('decrypt-password-input'))
      ).toBeVisible()
