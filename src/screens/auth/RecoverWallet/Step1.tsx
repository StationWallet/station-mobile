...
const Step1 = ({ navigation }: Props): ReactElement => {
  const setPassword = useSetAtom(RecoverWalletStore.password)
  const setName = useSetAtom(RecoverWalletStore.name)
  const setQRData = useSetAtom(RecoverWalletStore.qrData)
  const [seed, setSeed] = useAtom(RecoverWalletStore.seed)
