...
export const file_vultisig_vault_v1_vault: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
 ...
 */
export type Vault_KeyShare =
  Message<'vultisig.vault.v1.Vault.KeyShare'> & {
    /**
 ...
 */
export type Vault_ChainPublicKey =
  Message<'vultisig.vault.v1.Vault.ChainPublicKey'> & {
    /**
     * @generated from field: string public_key = 1;
     */
    publicKey: string
 ...
 */
export const Vault_ChainPublicKeySchema: GenMessage<Vault_ChainPublicKey> =
  /*@__PURE__*/
